namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        {
            Console.WriteLine("Da lista abaixo, digite a placa do veículo para remover:\n");
            foreach(string unidade in veiculos)
                {
            ...
            if (veiculos.Any(x => x.ToUpper() == placa.ToUpper()))
            {
                ...
                //Pede para o usuário digitar a quantidade de horas que o veículo permaneceu estacionado, e faz o calculo do valor total                
